...
var submitFunction = function(event) {
  ...
  var queryURL =
    "https://www.googleapis.com/youtube/v3/search?part=id&maxResults=25&order=relevance&q=" +
    q +
    "&type=video&videoEmbeddable=true&fields=items%2Fid&key=" +
    api_key;
  $.ajax({
    url: queryURL,
    method: "GET"
    ...
    $("#video").attr(
      "src",
      "https://www.youtube.com/embed/" + response.items[counter].id.videoId
    );
  });
};
